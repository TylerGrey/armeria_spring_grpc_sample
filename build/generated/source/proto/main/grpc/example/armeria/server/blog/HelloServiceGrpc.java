...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "example.server.hello.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Hello",
      requestType = example.armeria.server.blog.Hello.HelloRequest.class,
      responseType = example.armeria.server.blog.Hello.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest, example.armeria.server.blog.Hello.HelloReply> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<example.armeria.server.blog.Hello.HelloRequest, example.armeria.server.blog.Hello.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.armeria.server.blog.Hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  example.armeria.server.blog.Hello.HelloReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getLazyHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getLazyHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest, example.armeria.server.blog.Hello.HelloReply> getLazyHelloMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getBlockingHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getBlockingHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest, example.armeria.server.blog.Hello.HelloReply> getBlockingHelloMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getLotsOfRepliesMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getLotsOfRepliesMethod() {
    io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest, example.armeria.server.blog.Hello.HelloReply> getLotsOfRepliesMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getLotsOfGreetingsMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getLotsOfGreetingsMethod() {
    io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest, example.armeria.server.blog.Hello.HelloReply> getLotsOfGreetingsMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getBidiHelloMethod;
  ...
  public static io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest,
      example.armeria.server.blog.Hello.HelloReply> getBidiHelloMethod() {
    io.grpc.MethodDescriptor<example.armeria.server.blog.Hello.HelloRequest, example.armeria.server.blog.Hello.HelloReply> getBidiHelloMethod;
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(example.armeria.server.blog.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getHelloMethod(), responseObserver);
    }

    /**
     */
    public void lazyHello(example.armeria.server.blog.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply> responseObserver) {
    ...
    /**
     */
    public void blockingHello(example.armeria.server.blog.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply> responseObserver) {
    ...
    /**
     */
    public void lotsOfReplies(example.armeria.server.blog.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloRequest> lotsOfGreetings(
        io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloRequest> bidiHello(
        io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                example.armeria.server.blog.Hello.HelloRequest,
                example.armeria.server.blog.Hello.HelloReply>(
                  this, METHODID_HELLO)))
          .addMethod(
            getLazyHelloMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public example.armeria.server.blog.Hello.HelloReply hello(example.armeria.server.blog.Hello.HelloRequest request) {
    ...
    /**
     */
    public example.armeria.server.blog.Hello.HelloReply lazyHello(example.armeria.server.blog.Hello.HelloRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public example.armeria.server.blog.Hello.HelloReply blockingHello(example.armeria.server.blog.Hello.HelloRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public java.util.Iterator<example.armeria.server.blog.Hello.HelloReply> lotsOfReplies(
        example.armeria.server.blog.Hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<example.armeria.server.blog.Hello.HelloReply> hello(
        example.armeria.server.blog.Hello.HelloRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<example.armeria.server.blog.Hello.HelloReply> lazyHello(
        example.armeria.server.blog.Hello.HelloRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<example.armeria.server.blog.Hello.HelloReply> blockingHello(
        example.armeria.server.blog.Hello.HelloRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((example.armeria.server.blog.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply>) responseObserver);
          break;
        case METHODID_LAZY_HELLO:
          serviceImpl.lazyHello((example.armeria.server.blog.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply>) responseObserver);
          break;
        case METHODID_BLOCKING_HELLO:
          serviceImpl.blockingHello((example.armeria.server.blog.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply>) responseObserver);
          break;
        case METHODID_LOTS_OF_REPLIES:
          serviceImpl.lotsOfReplies((example.armeria.server.blog.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<example.armeria.server.blog.Hello.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return example.armeria.server.blog.Hello.getDescriptor();
    }
